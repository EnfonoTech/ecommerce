...
Replace `ecommerce`, `ecommerce`, `KSA` placeholders.

---

```markdown
# ecommerce — Claude Code Instructions
...
bench export-fixtures --app ecommerce       # after Custom Field changes
bench --site <site> run-tests --app ecommerce  # run all tests
